...
Access control must respect existing document permissions. Not everyone should be able to look up everything. The system must only surface documents the person asking is allowed to see.`,
    redesignData: {
      components: [
        ...
        { name: 'Answer capture', type: 'deterministic', description: 'Store the answer so the same question surfaces it next time', risks: ['Outdated answers persisting'], considerations: ['Expiry or review cycle for stored answers'] },
        { name: 'Confidence check', type: 'human', description: 'Low-confidence answers escalate to a person for review before being shared', risks: ['Review fatigue if volume is high'], considerations: ['Only route low-confidence answers, not everything'] },
      ],
