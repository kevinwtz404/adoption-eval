...
Access control must respect existing document permissions. Not everyone should be able to look up everything. The system must only surface documents the person asking is allowed to see.`,
    redesignData: {
      components: [
        { name: 'Access control', type: 'tool', description: 'Check who is asking and filter which documents they are allowed to see', risks: ['Permission mapping errors could expose confidential information'], considerations: ['Must mirror existing permission structure', 'Need to handle documents with mixed access levels'] },
        ...
        { name: 'Human review', type: 'human', description: 'Review low-confidence answers before they become authoritative', risks: ['Review fatigue if volume is high'], considerations: ['Only route low-confidence answers to review, not everything'] },
      ],
