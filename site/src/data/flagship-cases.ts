...
Access control must respect existing document permissions. Not everyone should be able to look up everything. The system must only surface documents the person asking is allowed to see.`,
    redesignData: {
      components: [
        ...
        { name: 'Confidence check', type: 'human', description: 'Low-confidence answers escalate to a person for review before being stored or shared', risks: ['Review fatigue if volume is high'], considerations: ['Only route low-confidence answers, not everything'] },
        { name: 'Answer capture', type: 'deterministic', description: 'Store verified answers so the same question surfaces them next time', risks: ['Outdated answers persisting'], considerations: ['Expiry or review cycle for stored answers'] },
      ],
...
The sales manager reviews pipeline with higher confidence because the underlying data is more complete and current. Outreach, relationship decisions, pricing and forecast sign-off all stay fully with people.`,
    redesignData: {
      components: [
        ...
        { name: 'Profile summary', type: 'llm', description: 'Summarise unstructured findings into the lead profile', risks: ['Hallucination in summaries', 'Outdated information'], considerations: ['A small model may be sufficient'] },
        ...
        { name: 'SDR reviews', type: 'human', description: 'SDR reviews enriched profile before any outreach', risks: ['Bottleneck if volume is high'], considerations: ['What needs review vs what can proceed automatically'] },
        { name: 'Handoff summary', type: 'llm', description: 'Generate structured handoff summary for AE from enriched data', risks: ['May miss context the SDR knows'], considerations: ['SDR can edit before sending'] },
