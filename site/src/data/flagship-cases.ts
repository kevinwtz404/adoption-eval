...
Approved versions are published to each channel and the system logs what went where and when.`,
    redesignData: {
      components: [
        ...
        { name: 'Copywriter', type: 'human', description: 'Reviews and refines generated text for tone, accuracy and brand voice', risks: ['Review fatigue'], considerations: ['Batch review interface'], _track: 'top' },
