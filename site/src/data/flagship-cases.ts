...
Approved versions are published to each channel and the system logs what went where and when.`,
    redesignData: {
      components: [
        ...
        { name: 'Creative review', type: 'human', description: 'Copywriter reviews and refines generated versions for tone, accuracy and brand voice', risks: ['Review fatigue'], considerations: ['Batch review interface'], _track: 'top' },
